...
class WordManager {
    ...
    private var wordList = ArrayList<com.learnwithsubs.word_list.domain.models.WordTranslation>()
    ...
    fun addWord(elem: com.learnwithsubs.word_list.domain.models.WordTranslation, index: Int) {
        wordList.add(elem)
    ...
    fun removeWord(elem: com.learnwithsubs.word_list.domain.models.WordTranslation, index: Int) {
    ...
    fun getWordsList(): List<com.learnwithsubs.word_list.domain.models.WordTranslation> = ArrayList(wordList)
